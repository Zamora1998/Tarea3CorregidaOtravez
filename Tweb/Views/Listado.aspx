...
<body>
    ...
    <script>
        ...
        tablaPlatillos.addEventListener('click', function (event) {
        ...
        function obtenerFilaSeleccionada() {
            ...
            return null; // Retorna null si no se ha seleccionado ninguna fila
        }
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            dropdownCategorias.addEventListener("click", function () {
                ...
                if (categoriaSeleccionadaTexto !== categoriaSeleccionada) {
                    ...
                    fetch(`http://localhost:50912/api/Listado/ListarPlatillosPorCategoria?categoriaSeleccionada=${categoriaSeleccionada}`)
                        .then(response => response.json())
                        .then(data => {
